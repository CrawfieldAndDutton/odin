...
async def create_payment_link(
    ...
    """
    try:
        reference_id, response = await PaymentHandler.create_payment_link(request, current_user)
...
async def verify_payment(
    ...
    try:
        ...
        if (razorpay_payment_link_status and
            ...
            redirect_url = f"{AppConfiguration.FRONTEND_BASE_URL}/"
...
async def manual_verify_payment(
    ...
    try:
        ...
        result = await PaymentHandler.manual_verify_payment(payment_link_id)
...
async def handle_webhook(request: PaymentWebhookRequest) -> Dict[str, Any]:
    ...
    try:
        ...
        result = await PaymentHandler.handle_webhook(request)
